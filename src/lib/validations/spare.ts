...
export const spareSchema = z.object({
    ...
    sellingPrice: z
        .number({ message: 'กรุณาระบุราคาขายเป็นตัวเลข' })
        .min(0, 'ราคาขายต้องไม่ต่ำกว่า 0'),
    costPrice: z
        .number({ message: 'กรุณาระบุต้นทุนเป็นตัวเลข' })
        .min(0, 'ต้นทุนต้องไม่ต่ำกว่า 0')
        .optional()
        .nullable(),
    minStock: z
        .number({ message: 'กรุณาระบุจำนวน Min เป็นตัวเลข' })
        .int('จำนวน Min ต้องเป็นจำนวนเต็ม')
        .min(0, 'จำนวน Min ต้องไม่ต่ำกว่า 0')
        .default(10),
    maxStock: z
        .number({ message: 'กรุณาระบุจำนวน Max เป็นตัวเลข' })
        .int('จำนวน Max ต้องเป็นจำนวนเต็ม')
        .min(0, 'จำนวน Max ต้องไม่ต่ำกว่า 0')
        .optional()
        .nullable(),
    currentStock: z
        .number({ message: 'กรุณาระบุจำนวนคงเหลือเป็นตัวเลข' })
